...
- [Class decorator with generic constraint](#class-decorator-with-generic-constraint)
- [Limitations](#limitations)
- [Examples](#examples)
  - [Add properties](#add-properties)
  - [Prevent modifications of a class](#prevent-modifications-of-a-class)
...
# Class decorator with generic constraint <a name="class-decorator-with-generic-constraint"></a>
In [part 1 of this series](https://dev.to/pinutz23/typescript-decorators-part-1-the-basics-37p5#overview-over-signatures) I already described the signature of the different types of decorators including the class decorator. We can use TypeScripts `extends` keyword to ensure the target is a constructor. That enables us to treat `target` as a constructor (that is why I renamed it to `constructor` in the following example) and use features like extending `constructor`.
...
## Add properties <a name="add-properties"></a>
The following example shows how to add additional attributes to the class and modifying them by passing a function to the decorator factory (see part 1 for the concept of [decorator factories](https://dev.to/pinutz23/typescript-decorators-part-1-the-basics-37p5#decorator-factories)).
...
## Prevent modifications of a class <a name="prevent-modifications-of-a-class"></a>
